...
module.exports = {
    ...
    // entry: ["./app/entry1", "./app/entry2"], // string | object | array
    entry: {
        bundle1: './app/main1.js',
    ...
    output: {
        ...
        filename: './js/[name].js', // 用于多个入口点(entry point)（出口点？）

        // filename: "bundle.js", // string
        // filename: "[chunkhash].js", // 用于长效缓存  「入口分块(entry chunk)」的文件名模板（出口分块？）
