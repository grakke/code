...
class GreeterClient implements \Greeter\GreeterIf
{
    ...
    {
        $args = new \Greeter\Greeter_hello_args();
        $args->name = $name;
    ...
    public function recv_hello()
    {
        ...
        if ($bin_accel) {
            ...
            $result = new \Greeter\Greeter_hello_result();
