...
echo substr_count($text, 'is', 3) . PHP_EOL; // 1 字符串被简化为 's is a tests'，因此输出 1
...
echo htmlspecialchars(
    "<a href='tests'>Test</a>",
    ENT_QUOTES
) . PHP_EOL; // &lt;a href=&#039;tests&#039;&gt;Test&lt;/a&gt; 将特殊字符转换为 HTML 实体
...
echo http_build_query(["hello", 'cancel-renewal' => null, null], '', '&&');
