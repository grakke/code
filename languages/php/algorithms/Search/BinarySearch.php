...
class BinarySearch
{
    ...
    public static function binarySearch(array $numbers, int $needle): bool
    {
        $low = 0;
    ...
    public static function repetitiveBinarySearch(array $data, int $needle)
    {
        $low = 0;
        $high = count($data);
        $firstIndex = -1;
    ...
    public static function binarySearch1(array $numbers, int $needle, int $low, int $high): bool
    {
        if ($high < $low) {
            return false;
        }
