...
import (
	...
	"github.com/grakke/instrument_trace/instrumenter"
	"github.com/grakke/instrument_trace/instrumenter/ast"
)
...
func main() {
	...
	ins = ast.New("github.com/grakke/instrument_trace", "trace", "Trace")
